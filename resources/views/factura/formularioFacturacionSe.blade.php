        ...
        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
            ...
            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Formulario de Facturacion Sector Educativo</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
            </div>
        ...
        function emitirFactura(){
            ...
            if($("#formularioGeneraFactura")[0].checkValidity()){
                ...
                if(arrayProductoCar.length > 0){
                    ...
                    $.ajax({
                        url   : "{{ url('factura/emitirFacturaSe') }}",
                        method: "POST",
                        data  : {
